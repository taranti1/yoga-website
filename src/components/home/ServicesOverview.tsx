        ...
        {services.map((service, i) => (
          ...
          >
            <Link href={service.href} className="block h-full">
              <div className="bg-warm-white rounded-2xl p-8 lg:p-10 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 h-full flex flex-col">
                ...
                <p className="font-body text-sm text-charcoal/70 leading-relaxed mb-6 flex-1">
                  {service.description}
                </p>
                <span className="inline-flex items-center font-body text-sm font-semibold text-sage tracking-wide uppercase mt-auto">
                  Learn More
